...
const validSchemaLogger = createLogger({
...
const lenientLogger = createLogger({
...
const strictLogger = createLogger({
...
const validationOffLogger = createLogger({
